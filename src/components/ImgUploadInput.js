...
const ImgUploadInput = (options) => {
  ...
  const { multiple, accept, icon, button, className, description, change, name, previewImage, deleteButton } = options;
  ...
  return (
    <div className={`w-full h-[400px] m-auto bg-white rounded relative ${className}`} >
      {deleteButton ?
